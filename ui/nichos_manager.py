...
class BatchNichosDialog:
    ...
    def save(self):
        ...
        try:
            fila_inicio = int(self.fila_inicio_var.get())
            fila_fin = int(self.fila_fin_var.get())
            columna_inicio = int(self.columna_inicio_var.get())
            columna_fin = int(self.columna_fin_var.get())
            precio = float(self.precio_var.get())
